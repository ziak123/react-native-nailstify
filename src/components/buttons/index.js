...
export const Colored = ({
    ...
    return (
        <TouchableOpacity onPress={onPress} disabled={isLoading ? true : disabled} activeOpacity={"0.8"}>
            <Wrapper animation={animation} style={[appStyles.buttonColord, { borderRadius: sizes.buttonRadius, height:height(5.66),width:width(84), backgroundColor: disabled ? colors.appColor1 + '80' : buttonColor ? buttonColor : colors.appColor1 }, buttonStyle]}>

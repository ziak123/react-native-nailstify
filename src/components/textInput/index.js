            ...
            style={[{ marginHorizontal: sizes.marginHorizontal }, containerStyle]}>
            {
                title ?
                    <Wrapper style={{ marginHorizontal: 0 }}>
                        <Text isInput style={[{fontWeight:"bold",fontSize:totalSize(1.5)}, titleStyle]}>{title}</Text>
                        <Spacer isTiny />
                    </Wrapper>
                    :
                    null
                ...
                <View style={{ flex: 1 }}>
                    {
                        onPress ?
                            ...
                            <TextInput
                                ...
                                secureTextEntry={secureTextEntry}
                                maxLength={maxLength}
                                style={[appStyles.inputField, { width: null, height: height(5.98), paddingHorizontal: sizes.marginHorizontal , borderRadius:15}, inputStyle]}
                            />
                    }
                </View>
                <View style={{ }}>
...
export { Colored, Bordered, Underlined, SearchBar , Search }